...
import com.example.manrique.masterdetailfirebaseapp.dummy.DummyContent
import com.example.manrique.masterdetailfirebaseapp.smartphone.Smartphone
import com.example.manrique.masterdetailfirebaseapp.smartphone.SmartphoneContent
...
/**
 * A fragment representing a single smartphone detail screen.
 * This fragment is either contained in a [smartphoneListActivity]
 * in two-pane mode (on tablets) or a [smartphoneDetailActivity]
 * on handsets.
 */
